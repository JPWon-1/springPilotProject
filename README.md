...
- [<2021년 5월 03일>](projectDiary/2021-05-03.md) : feat user authorization : WebSecurityConfig 클래스 생성. TODO: authorization 구현해야함. 어려운 부분이 많아서 시간이 걸릴것 같다.
...
- [<2021년 5월 15일>](projectDiary/2021-05-15.md) : Spring Security를 이용한 회원가입 , 로그인 구현하는 중.
...
- [<2021년 5월 19일>](projectDiary/2021-05-19.md) : 회원가입시 비밀번호 bCryption해주었고 @EnableGlobalMethodSecurity(securedEnabled = true, prePostEnabled = true)
